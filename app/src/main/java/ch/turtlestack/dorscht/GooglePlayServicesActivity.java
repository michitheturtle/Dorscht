...
public class GooglePlayServicesActivity extends Activity implements
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        // Obtain User Info and save them in the MyApplication Object.
        Person user = Plus.PeopleApi.getCurrentPerson(mGoogleApiClient);
        ((MyApplication) this.getApplication()).setUserAccount(user);

        // Start MainActivity
        Intent myIntent = new Intent(GooglePlayServicesActivity.this, MainActivity.class);
        GooglePlayServicesActivity.this.startActivity(myIntent);
        finish();
    }
